...
describe('ConfluenceProxy / fixCaptionImage', () => {
    ...
    it('FixCaptionImage should create caption', () => {
        ...
        expect(context.getHtmlBody().includes('<figcaption>exampleCaption 1</figcaption>')).toBe(true);
    });
    ...
    it('FixCaptionImage should take into account if same caption for the same file was already used', () => {
        ...
        fixCaptionImage()(context);
        expect(context.getHtmlBody().includes('<figcaption>exampleCaption 1</figcaption>')).toBe(true);
        expect(context.getHtmlBody().includes('<figcaption>exampleCaption 2</figcaption>')).toBe(true);
    });
});
