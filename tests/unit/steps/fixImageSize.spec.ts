...
describe('ConfluenceProxy / fixImageSize', () => {
    ...
    it('should add a width attribute for img tag', () => {
        const imgTagWithoutWidth = '<img id = "imgId1" class="image-center" src="" data-height="291" data-width="289">'
    ...
    it('should not add a width attribute for img with width', () => {
        const imgTagWithWidth = '<img id = "imgId2" class="image-center" width="300" src="" data-height="291" data-width="289">'
